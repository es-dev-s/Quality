...
const CHAT_SECTIONS: AuditSection[] = [
  {
    id: "chat-compliance",
    name: "Chat Compliance",
    isFatal: false,
    params: [
      yn("chat-greeting", "Greeting", 2, "Chat Compliance"),
      yn("chat-closing", "Closing", 2, "Chat Compliance"),
      yn("chat-response-time", "Response Time", 8, "Chat Compliance"),
      yn("chat-followup", "Follow Up", 5, "Chat Compliance"),
    ],
  },
  {
    id: "chat-etiquette",
    ...
    isFatal: false,
    params: [
      eeme("chat-listening", "Active Listening", 4, 2, "Chat Etiquette"),
      eeme("chat-empathy", "Empathy/Apology", 4, 2, "Chat Etiquette"),
      eeme("chat-politeness", "Politeness", 4, 2, "Chat Etiquette"),
      eeme("chat-grammar", "Grammar & Sentence", 5, 3, "Chat Etiquette"),
      eeme("chat-professionalism", "Professionalism", 4, 2, "Chat Etiquette"),
      eeme("chat-clarity", "Message Clarity", 4, 2, "Chat Etiquette"),
      eeme("chat-context", "Context Setting", 4, 2, "Chat Etiquette"),
      yn("chat-preferred-mode", "Preferred Mode (Chat/Call)", 4, "Chat Etiquette"),
    ],
  },
  {
    id: "chat-resolution",
  ...
  },
  {
    ...
    isFatal: false,
    params: [
      ynFatal("chat-alltagged", "All Queries Tagged", 5, "Chat Disposition"),
      ynFatal("chat-correcttag", "Correct Tagging", 5, "Chat Disposition"),
    ],
  },
  cmmSection("chat"),
];
